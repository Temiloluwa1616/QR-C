...
async function handleSubmit(e) {
  ...
  console.log('Submit button clicked')
    try {
      setLoading(true);
      const response = await fetch('https://wild-gold-coyote-wear.cyclic.app/api/intern/add-intern'
, {
        method: 'POST',
...
function handlegenerateQrcode() {
  if (name.trim || phone.trim || email.trim || duration.trim() !== "") {
    setLoading(true);
...
<div className='w-[50%]  bg-bgg justify-center flex h-screen'>
  <form action="" className='mt-[2rem]' onSubmit={handleSubmit}>
    ...
    >
      ...
      <option value="BackEnd">BackEnd</option>
       ...
       <option value="Data Anyalytics">Data Anyalytics</option>
    </select>
            </div>
      ...
      required
    >
      <option className='text-gray'>Duration</option>
